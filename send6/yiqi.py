...
def put_stationdata(client,cfg,recv_mq):
    ...
    Out_info = doc.createTextNode(str(textdescription))
    ...
    Palletnumber_info = doc.createTextNode(str(palletnumber))
    ...
    Palletcycletimescount_info = doc.createTextNode(str(palletcycletimescount))
    ...
    Pallettype_info = doc.createTextNode(str(pallettype))
    ...
    Lastworkstation_info = doc.createTextNode(str(lastworkstation))
    ...
    Palletloaded_info = doc.createTextNode(str(palletloaded))
    ...
    Palletworkok_info = doc.createTextNode(str(palletworkok))
    ...
    Palletworknok_info = doc.createTextNode(str(palletworknok))
    ...
    Palletscrapped_info = doc.createTextNode(str(palletscrapped))
    ...
    Palletworkposition_info = doc.createTextNode(str(palletworkposition))
    ...
    Repairstatus_info = doc.createTextNode(str(repairstatus))
    ...
    Repairtimescount_info = doc.createTextNode(str(repairtimescount))
    ...
    Ilchecktimescount_info = doc.createTextNode(str(ilchecktimescount))
    ...
    Eolchecktimescount_info = doc.createTextNode(str(eolchecktimescount))
    ...
    Dateandtimeid_info = doc.createTextNode(str(dateandtimeid))
    ...
    Batteryid_info = doc.createTextNode(str(batteryid))
    ...
    Bzd_batterycase_info = doc.createTextNode(str(bzd_batterycase))
    ...
    Bzd_batterypack_info = doc.createTextNode(str(bzd_batterypack))
    ...
    Gapfillermodule1_info = doc.createTextNode(str(gapfillermodule1))
    ...
    Gapfillermodule2_info = doc.createTextNode(str(gapfillermodule2))
    ...
    Gapfillermodule3_info = doc.createTextNode(str(gapfillermodule3))
    ...
    Gapfillermodule4_info = doc.createTextNode(str(gapfillermodule4))
    ...
    Gapfillermodule5_info = doc.createTextNode(str(gapfillermodule5))
    ...
    Gapfillermodule6_info = doc.createTextNode(str(gapfillermodule6))
    ...
    Gapfillermodule7_info = doc.createTextNode(str(gapfillermodule7))
    ...
    Gapfillermodule8_info = doc.createTextNode(str(gapfillermodule8))
    ...
    Gapfillermodule9_info = doc.createTextNode(str(gapfillermodule9))
    ...
    Gapfillermodule10_info = doc.createTextNode(str(gapfillermodule10))
    ...
    Gapfillermodule11_info = doc.createTextNode(str(gapfillermodule11))
    ...
    Gapfillermodule12_info = doc.createTextNode(str(gapfillermodule12))
    ...
    Gapfillermodule13_info = doc.createTextNode(str(gapfillermodule13))
    ...
    Gapfillermodule14_info = doc.createTextNode(str(gapfillermodule14))
    ...
    Gapfillermodule15_info = doc.createTextNode(str(gapfillermodule15))
    ...
    Recipeversion_info = doc.createTextNode(str(recipeversion))
    ...
    Bomversion_info = doc.createTextNode(str(bomversion))
    ...
    Work_ok_info = doc.createTextNode(str(work_ok))
    ...
    Work_nok_info = doc.createTextNode(str(work_nok))
    ...
    Workerdecisionok_info = doc.createTextNode(str(workerdecisionok))
    ...
    Workerdecisionnok_info = doc.createTextNode(str(workerdecisionnok))
...
def put_boschdata(client,cfg,recv_mq):
    data = get_data(client, "bosch", cfg)
    if data is None:
        # logging.DEBUG("data=None")
        return
    ...
    location = doc.createElement("Location")
    sender.appendChild(location)
    sender_assembly_cycle = get_item(data[1], u"assembly_cycle")
    location.setAttribute("assembly_cycle", sender_assembly_cycle)
    location.setAttribute("assembly_line", "MES Battery Assembly Line")
    location.setAttribute("assembly_subline", "1")
    location.setAttribute("plant", "C4")
    ...
    device = doc.createElement("Device")
    sender.appendChild(device)
    sender_hostname = get_item(data[1], u"esn")
    device.setAttribute("hostname", sender_hostname)
    sender_manufacturer = get_item(data[1], u"manufacturer")
    device.setAttribute("manufacturer", sender_manufacturer)
    sender_type = get_item(data[1], u"type")
    device.setAttribute("type", sender_type)
    sender_opmode = get_item(data[1], u"opmode")
    device.setAttribute("opmode", sender_opmode)

    telegraminfo = doc.createElement("Telegraminfo")
    herder.appendChild(telegraminfo)
    sender_timestamp = get_item(data[1], u"opmode")
    telegraminfo.setAttribute("timestamp", sender_timestamp)
    sender_datatype = get_item(data[1], u"opmode")
    telegraminfo.setAttribute("datatype", sender_datatype)
    ...
    cid = get_item(data[1], u"psn")
    batterdata.setAttribute("cid", cid)
    pt1 = get_item(data[1], u"gbt")
    batterdata.setAttribute("pt1", pt1)
    ...
    for i in range(len(data)):
        ...
        jobid = get_item(data[i], u"jobid")
        Jobid_info = doc.createTextNode(str(jobid))
        Jobid.appendChild(Jobid_info)
        obj.appendChild(Jobid)

        Jobnumber = doc.createElement("jobnumber")
        jobnumber = get_item(data[i], u"jobnumber")
        Jobnumber_info = doc.createTextNode(str(jobnumber))
        Jobnumber.appendChild(Jobnumber_info)
        obj.appendChild(Jobnumber)

        Textdescription = doc.createElement("textdescription")
        textdescription = get_item(data[i], u"textdescription")
        Textdescription_info = doc.createTextNode(str(textdescription))
        Textdescription.appendChild(Textdescription_info)
        obj.appendChild(Textdescription)

        Stationnumber = doc.createElement("stationnumber")
        stationnumber = get_item(data[i], u"stationnumber")
        Stationnumber_info = doc.createTextNode(str(stationnumber))
        Stationnumber.appendChild(Stationnumber_info)
        obj.appendChild(Stationnumber)

        Channel = doc.createElement("channel")
        channel = get_item(data[i], u"channel")
        Channel_info = doc.createTextNode(str(channel))
        Channel.appendChild(Channel_info)
        obj.appendChild(Channel)

        Location = doc.createElement("location")
        location = get_item(data[i], u"location")
        Location_info = doc.createTextNode(str(location))
        Location.appendChild(Location_info)
        obj.appendChild(Location)

        Qualtitycode = doc.createElement("qualtitycode")
        qualtitycode = get_item(data[i], u"qualtitycode")
        Qualtitycode_info = doc.createTextNode(str(qualtitycode))
        Qualtitycode.appendChild(Qualtitycode_info)
        obj.appendChild(Qualtitycode)

        Torque = doc.createElement("torque")
        torque = get_item(data[i], u"torque")
        Torque_info = doc.createTextNode(str(torque))
        Torque.appendChild(Torque_info)
        obj.appendChild(Torque)

        Angle = doc.createElement("angle")
        angle = get_item(data[i], u"angle")
        Angle_info = doc.createTextNode(str(angle))
        Angle.appendChild(Angle_info)
        obj.appendChild(Angle)

    xml = open("bosch.xml", "w")
    doc.writexml(xml, indent='\t', newl='\n', addindent='\t', encoding='gbk')
    xml.close()

    with open("bosch.xml", "rt") as xml:
        line = xml.read()
        print(line)
